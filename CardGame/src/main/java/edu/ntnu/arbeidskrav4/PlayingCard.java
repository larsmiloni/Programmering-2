...
public class PlayingCard {
  ...
  private final char suit; // 'S'=spade, 'H'=hearts, 'D'=diamonds, 'C'=clubs
  ...
  public PlayingCard(char suit, int face) throws IllegalArgumentException {
    if (face < 1) throw new IllegalArgumentException("Face of card cannot be less than zero.");
    if (face > 13) throw new IllegalArgumentException("Face of card cannot be more that 13.");
    this.suit = suit;
    this.face = face;
  }
